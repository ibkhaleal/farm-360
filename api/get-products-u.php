...
$query = "SELECT id, itemName AS name, orgId AS warehouseId, orgName AS warehouseName, orgMobile AS warehouseMobile, orgImage AS warehouseImage, orgAddress AS warehouseAddress, weight, dateAdded FROM items WHERE ownerId = '$userId'";
